...
$result = ExecuteCommand "func azure functionapp fetch-app-settings $namePrefix-health-api" $loggingPrefix "Fetching the API app settings from azure."
...
$result = ExecuteCommand "func settings add ""Host.LocalHttpPort"" ""7001""" $loggingPrefix "Adding the worker run time port setting for '7073'."
