...
ExecuteCommand "func azure functionapp fetch-app-settings $systemName-$microserviceName-api" $loggingPrefix "Fetching the API app settings from azure."
...
ExecuteCommand "func azure functionapp fetch-app-settings $systemName-$microserviceName-worker" $loggingPrefix "Fetching the worker app settings from azure."
