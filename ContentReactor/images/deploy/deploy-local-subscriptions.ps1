...
$loggingPrefix = "Images Worker Subcriptions ($systemName)"
...
$command = "az group deployment create -g $eventsResourceGroupName --template-file ./eventGridSubscriptions-images.local.json --parameters uniqueResourcesystemName=$systemName publicUrlToLocalWebServer=$publicUrlToLocalWebServer uniqueDeveloperId=$uniqueDeveloperId"
