...
Write-Host "https://portal.azure.com/#@boundbybetter.com/resource/subscriptions/$((Get-AzSubscription).Id)/resourceGroups/$($EdenEnvConfig.EnvironmentName)-audio/providers/Microsoft.Insights/components/$($EdenEnvConfig.EnvironmentName)-audio-ai/applicationMap" -ForegroundColor Blue
Write-Host "" -ForegroundColor Blue
