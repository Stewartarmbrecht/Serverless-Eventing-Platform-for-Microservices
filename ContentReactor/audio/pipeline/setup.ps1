...
$loggingPrefix = "$systemName $microserviceName Setup"

Set-Location "$location/../$microserviceName/api"
Invoke-BuildCommand "func azure functionapp fetch-app-settings $systemName-$microserviceName-api" $loggingPrefix "Fetching the API app settings from azure."
...
Invoke-BuildCommand "func azure functionapp fetch-app-settings $systemName-$microserviceName-worker" $loggingPrefix "Fetching the worker app settings from azure."
