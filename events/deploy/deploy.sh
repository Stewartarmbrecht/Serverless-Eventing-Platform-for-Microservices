...
usage()
{
    echo "This script deploys the events microservice.  It responds to the following parameters."
    echo ""
    echo "./deploy.sh"
    echo "    -h --help"
...
time ./deploySteps.sh $uniquePrefixString

D "Events deployment complete for $uniquePrefixString!"